...
SECRET_KEY = 'django-insecure-1-b7y4m0z4=^etrf78s+!33khm6o&-50ctg-&1alf(h5=q)=hp'
...
REST_FRAMEWORK = {
    'DEFAULT_PARSER_CLASSES': (
        ...
        'rest_framework.parsers.MultiPartParser',  # Include this line for file uploads
    )
}
...
# MEDIA_ROOT = os.path.join(BASE_DIR, 'patient', 'media')
